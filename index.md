...
As such, it is clear to see how important access to technology such as the internet has become to education attainment.  Therefore, for this project, we would like to investigate the relationship between access to technology and  education attainment.

For our investigation, we decided to focus on Alabama for the following reasons: large differences in tech access and enrollment across the counties and the tech accessibility initiatives in certain counties.  

<center><iframe width="560" height="315" src="interactive_alabama.html" title="Internet Access Map" frameborder="0"></iframe></center>

For example, in the following graph, we can start to observe how sporadic the counties are in terms of internet access and education attainment.
...
{::options parse_block_html="true" /}
<div class="infogram-embed" data-id="2ba77b2a-c5b8-43d3-89e3-2cb152e24d36" data-type="interactive" data-title="Bar graphs"></div><script>!function(e,i,n,s){var t="InfogramEmbeds",d=e.getElementsByTagName("script")[0];if(window[t]&&window[t].initialized)window[t].process&&window[t].process();else if(!e.getElementById(n)){var o=e.createElement("script");o.async=1,o.id=n,o.src="https://e.infogram.com/js/dist/embed-loader-min.js",d.parentNode.insertBefore(o,d)}}(document,0,"infogram-async");</script><div style="padding:8px 0;font-family:Arial!important;font-size:13px!important;line-height:15px!important;text-align:center;border-top:1px solid #dadada;margin:0 30px"><a href="https://infogram.com/2ba77b2a-c5b8-43d3-89e3-2cb152e24d36" style="color:#989898!important;text-decoration:none!important;" target="_blank">Bar graphs</a><br><a href="https://infogram.com" style="color:#989898!important;text-decoration:none!important;" target="_blank" rel="nofollow">Infogram</a></div>
{::options parse_block_html="false" /}
